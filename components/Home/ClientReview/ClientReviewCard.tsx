  ...
  return (
    <div className='m-2'>
        ...
        <p className='mt-6 text-base text-gray-200 font-medium'>
            &quot; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur quo ex iste obcaecati debitis, tenetur maxime aperiam quisquam animi, repudiandae doloremque quis commodi, veniam maiores voluptates saepe laborum? Praesentium, atque? &quot;
        </p>
